...
// Melodia  6:Estrellita
notas de char [] = " ccggaag ffeeddc ggffeed ggffeed ccggaag ffeeddc " ; // unespacio representa un descanso
...
int tiempoInicialTone = 0;
int tiempoActualTone = 0;

void iniciarMelodia(int speakerOut1){
  speakerOut = speakerOut1;
